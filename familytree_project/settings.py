...
ALLOWED_HOSTS = ["mot.gov.metasoft-ar.com","127.0.0.1"]
...
STATIC_ROOT = '/root/metasoft/familytree_project/staticfiles'

MEDIA_URL = '/media/'
MEDIA_ROOT = '/root/metasoft/familytree_project/media'
